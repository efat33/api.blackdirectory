...
class FinanceModel {
    ...
    getFinance = async (params = {}, page = 1, limit = -1) => {
        let sql = `SELECT *
            FROM ${this.tableName}`;
        ...
        const output = {}
        output.finance = travels;
        output.total_finance = total_travels;
        
        return output;
    }

    getSingleFinance = async (params = {}) => {
        let sql = `SELECT * 
            FROM ${this.tableName}`;
