...
const { isAdmin, canCreateForum, canCreateTopic, canCreateReply } = require('../utils/common');

const validation = require('../utils/listingValidator');

router.post('/add-reply', apiKey(), authVerified(), canCreateReply(), awaitHandlerFactory(forumController.newReply));
